...
(defun dotspacemacs/user-config ()
  ...
  (setq helm-ag-base-command "rg --color never --glob=!.git/* --hidden --line-number --no-heading --smart-case --text")
